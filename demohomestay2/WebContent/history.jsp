...
%>
    ...
    <div class="homestay-grid">
        <c:forEach items="${lichSuDatPhongList}" var="lichSuDatPhong">
    <p>Tên người đặt: ${lichSuDatPhong.tenNguoiDat}</p>
    <p>Email người đặt: ${lichSuDatPhong.emailNguoiDat}</p>
    <p>Số điện thoại người đặt: ${lichSuDatPhong.soDienThoaiNguoiDat}</p>
    <!-- Các thông tin khác về đặt phòng -->
    <hr>
</c:forEach>
