                    ...
                    <li><a href="ServletLichSuDatPhong">LỊCH SỬ ĐẶT PHÒNG</a></li>
                        <li>
                            ...
                            <ul class="submenu">
                                ...
                                <li><a href="https://www.tiktok.com/@danhkoluumanh?_t=8hbhDEnWZMN&_r=1">Tiktok</a></li>
                            </ul>
                        </li>
                        <li>
            ...
            <main>
                <div id="banner">
                 ...
                 <div class="success-message">
                    ...
                    <h2>Sửa thông tin thành công!</h2>
                    <p>Cảm ơn bạn đã chọn chúng tôi. Chúng tôi sẽ liên hệ với bạn để xác nhận đơn đặt phòng của bạn.</p>
                </div>
